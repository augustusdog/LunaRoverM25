...
As tempting as it is to just buy a really great looking tracked vehicle which can carry a 10kg payload (fro AliExpress), I thought of some quick ways to improve the LunaRover - which are: flip it upside down for more clearance (will remount electronics), replace control mechanism with a 2.4GHz transmitter and ESC. Flipping it upside down worked well and drag was reduced to the point where it could be driven around the garden!
